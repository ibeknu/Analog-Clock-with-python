...
# jam
    for i in range(12):
        ...
        if i == 0:
            canvas.create_text(x, y-10, text=str(i+12), font=("Helvatica", 12))

        else:
            canvas.create_text(x, y, text=str(i), font=("Helvatica", 12))
